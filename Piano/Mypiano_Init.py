...
In the first piece of code I specify the funwavhe .wav and
...
def note_C0():
	num1.set("C_0")
	sound = pygame.mixer.Sound("wav/c1.wav")
	sound.play()


def note_CC0():
	num1.set("C#_0")
	sound = pygame.mixer.Sound("wav/c1s.wav")
	sound.play()

def note_D0():
	num1.set("D_0")
	sound = pygame.mixer.Sound("wav/d1.wav")
	sound.play()

def note_DD0():
	num1.set("D#_0")
	sound = pygame.mixer.Sound("wav/d1s.wav")
	sound.play()

def note_E0():
	num1.set("E_0")
	sound = pygame.mixer.Sound("wav/e1.wav")
	sound.play()

def note_F0():
	num1.set("F_0")
	sound = pygame.mixer.Sound("wav/f1.wav")
	sound.play()

def note_FF0():
	num1.set("F#_0")
	sound = pygame.mixer.Sound("wav/f1s.wav")
	sound.play()

def note_G0():
	num1.set("G_0")
	sound = pygame.mixer.Sound("wav/g1.wav")
	sound.play()

def note_GG0():
	num1.set("G#_0")
	sound = pygame.mixer.Sound("wav/g1s.wav")
	sound.play()

def note_A0():
	num1.set("A_0")
	sound = pygame.mixer.Sound("wav/a1.wav")
	sound.play()

def note_AA0():
	num1.set("A#_0")
	sound = pygame.mixer.Sound("wav/a1s.wav")
	sound.play()

def note_B0():
	num1.set("B_0")
	sound = pygame.mixer.Sound("wav/b1.wav")
	sound.play()
